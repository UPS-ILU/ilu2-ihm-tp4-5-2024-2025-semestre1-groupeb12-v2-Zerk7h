...
public class InterfaceNoyauFonctionnel {
    ...
    public void recupererDate(LocalDate date){
        ...
        System.out.printf("La date: %d a été selectioné", date1);
    }
    
    public void recupererHeure(String heure){
        String heure1 = heure;
        System.out.printf("L'heure: %s a été selectioné", heure1);
    }
    
    public void recupererNbPersonne(int nbPersonne){
        int nb = nbPersonne;
        System.out.printf("Le nombre de personne: %d a été selectioné", nb);
    }
    
    public void recuperTable(String table){
        String table1 = table;
        System.out.printf("la table: %s a été selectioné", table1);
    }
}
